...
/** Solo procesar respuestas después de que el paciente recibió al menos un recordatorio. */
export function canAcceptPatientReply(visit) {
  return Boolean(visit?.sent5dPatient || visit?.sent2dPatient);
}
