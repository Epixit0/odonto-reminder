...
/** Envía recordatorios de citas programadas (6 h antes). Usado por cron Vercel y polling del dashboard. */
export async function runAppointmentReminders() {
  ...
  return { ok: true, sent, skipped, total: visits.length, errors: errors.length > 0 ? errors : undefined };
}
