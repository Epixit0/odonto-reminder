...
export async function sendWhatsAppMessage(to, text) {
  ...
  // Extraer el chatId real del messageId
  // Formato típico: "true_584121985398@c.us_3EB0C1..." o "true_251573733195975@lid_3EB0C1..."
  let resolvedChatId = null;
  if (body?.data?.messageId) {
    const parts = body.data.messageId.split("_");
    // parts[1] debería ser el chatId: "584121985398@c.us" o "251573733195975@lid"
